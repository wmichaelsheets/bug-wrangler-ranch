...
const journey = journeyMaker()                  //journeyMaker not a function because not exported from journey.js. Fixed
...
cattle.forEach(cow => {                     //modified to, serially, retrieve the breed of each cow in cattle.
